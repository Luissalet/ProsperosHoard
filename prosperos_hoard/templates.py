...
def tracklist_back(variant: str = "classic") -> dict[str, Any]:
    ...
    return {
        ...
        "layers": [
            ...
            {"type": "text", "x": 200, "y": 1120, "w": w - 400, "h": 110, "text": {"field": "title", "default": ""},
             "font": "space-grotesk", "size": 72, "colour": "#e8e2f0c0", "align": "center", "letter_spacing": 0.12,
             "uppercase": True},
            {"type": "text", "x": 420, "y": 1280, "w": w - 840, "h": 1300, "text": {"field": "tracks"},
             "font": "space-grotesk", "size": 96, "colour": "#e8e2f0ff", "align": "left", "line_height": 1.5},
            {"type": "text", "x": 300, "y": 2640, "w": w - 600, "h": 260, "text": {"field": "credits", "default": ""},
             "font": "space-grotesk", "size": 48, "colour": "#e8e2f099", "align": "center", "line_height": 1.4},
            {"type": "grain", "amount": 4},
        ],
    }
